...
enum : uint16
{
	...
	PKT_C_UPDATE_NICKNAME = 1012,
	PKT_S_UPDATE_NICKNAME = 1013,
	PKT_C_DELETE_ACCOUNT = 1014,
	PKT_S_DELETE_ACCOUNT = 1015,
	PKT_C_CHAT = 1016,
	PKT_S_CHAT = 1017,
	PKT_C_SHOUT = 1018,
	PKT_S_SHOUT = 1019,
	PKT_C_WHISPER = 1020,
	PKT_S_WHISPER = 1021,
	PKT_C_REQUEST_FRIEND = 1022,
	PKT_S_REQUEST_FRIEND = 1023,
	PKT_C_ACCEPT_FRIEND = 1024,
	PKT_S_ACCEPT_FRIEND = 1025,
	PKT_C_REJECT_FRIEND = 1026,
	PKT_S_REJECT_FRIEND = 1027,
	PKT_C_GET_PENDING_FRIENDS = 1028,
	PKT_S_GET_PENDING_FRIENDS = 1029,
	PKT_C_GET_FRIEND_LIST = 1030,
...
public:
	static void Init()
	{
		...
		GPacketHandler[PKT_S_SHOUT] = [](SharedPtr<Session> SessionPtr, BYTE* Buffer, int32 iLen)
		{
			return HandlePacket<Protocol::S_SHOUT>(Handle_S_SHOUT, SessionPtr, Buffer, iLen);
		};
		GPacketHandler[PKT_S_WHISPER] = [](SharedPtr<Session> SessionPtr, BYTE* Buffer, int32 iLen)
		{
			return HandlePacket<Protocol::S_WHISPER>(Handle_S_WHISPER, SessionPtr, Buffer, iLen);
		};
		...
		GPacketHandler[PKT_S_AI_CHAT] = [](SharedPtr<Session> SessionPtr, BYTE* Buffer, int32 iLen)
		{
			return HandlePacket<Protocol::S_AI_CHAT>(Handle_S_AI_CHAT, SessionPtr, Buffer, iLen);
		};
	}
	...
	static SendBufferRef MakeSendBuffer(Protocol::C_SHOUT& Pkt) { return _MakeSendBuffer(Pkt, PKT_C_SHOUT); }
	static SendBufferRef MakeSendBuffer(Protocol::C_WHISPER& Pkt) { return _MakeSendBuffer(Pkt, PKT_C_WHISPER); }
	...
	static SendBufferRef MakeSendBuffer(Protocol::C_AI_CHAT& Pkt) { return _MakeSendBuffer(Pkt, PKT_C_AI_CHAT); }
